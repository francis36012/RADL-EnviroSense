...
<html>
	...
	<body>
		...
		<div class="col-xs-12 col-md-6 col-md-offset-3">
						...
						<fieldset class="input-group-vertical">
							...
							<div class="input-group form-group">
								...
								<span class="input-group-btn">
									<button class="btn btn-default" type="submit" form="formLogin">
			...
			<div class="row">
			<div class="col-xs-12">
				<small><a href="#forgotPassword" id="forgotPasswordToggle" data-toggle="collapse" >Forgot Password</a></small>
